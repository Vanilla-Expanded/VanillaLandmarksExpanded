...
{
    public class Building_ToxicVent : Building
    {

        private ToxicSprayer steamSprayer;
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            this.steamSprayer = new ToxicSprayer(this);
        ...
        private void StartSpray()
        {
            ...
            GasUtility.AddGas(Position, Map, GasType.ToxGas, (float)5);
