...
{
    public class Building_SmokeVent : Building
    {

        private SmokeSprayer steamSprayer;
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            this.steamSprayer = new SmokeSprayer(this);
        ...
        private void StartSpray()
        {
            ...
            GasUtility.AddGas(Position, Map, GasType.BlindSmoke, (float)5);
