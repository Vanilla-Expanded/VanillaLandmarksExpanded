...
{
    public class GenStep_Driftwood : GenStep
    {
        ...
        public override void Generate(Map map, GenStepParams parms)
        {
            ...
            NoiseDebugUI.StoreNoiseRender(freqFactorNoise, "driftwood_chunks_freq_factor");
        ...
        private void GrowLowRockFormationFrom(IntVec3 root, Map map)
        {
            ...
            ThingDef thingDef = InternalDefOf.VEE_DriftwoodChunk;
