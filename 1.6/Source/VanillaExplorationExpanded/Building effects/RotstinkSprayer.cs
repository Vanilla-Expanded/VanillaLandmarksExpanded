...
{
    public class RotstinkSprayer
    {
        public RotstinkSprayer(Thing parent)
        {
            this.parent = parent;
        }
        ...
        {
            MoteThrown moteThrown = (MoteThrown)ThingMaker.MakeThing(InternalDefOf.VEE_RotstinkMote, null);
