...
{
    public class DeadlifeSprayer
    {
        public DeadlifeSprayer(Thing parent)
        {
            this.parent = parent;
        }
        ...
        {
            MoteThrown moteThrown = (MoteThrown)ThingMaker.MakeThing(InternalDefOf.VEE_DeadlifeMote, null);
